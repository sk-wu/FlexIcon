...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--how_many', type=int, default=30000, help='how many test images to run')
        ...
        self.parser.add_argument('--test_palette_json', type=str, default=None, help='test palette json file')
