...
from data.data_loader import CreateDataLoader_1
...
data_loader = CreateDataLoader_1(opt)
...
for epoch in range(start_epoch, opt.niter + opt.niter_decay + 1):
    ...
    for i, data in enumerate(dataset, start=epoch_iter):
        ...
        loss_G = loss_dict['G_GAN'] + loss_dict.get('G_GAN_Feat', 0) + loss_dict.get('G_VGG', 0) + loss_dict.get('G_VGG_Refine', 0) + \
                     loss_dict.get('G_Ctx', 0) + loss_dict.get('G_Content_Consistency', 0) + loss_dict.get('G_Style_Contrastive', 0) + loss_dict.get('G_Perc', 0) + loss_dict.get('G_Contrastive', 0) + \
        ...
        if save_fake:
            visuals = OrderedDict([('input_label', util.tensor2label(data['label'][0], opt.label_nc)),
                                   ...
                                   ('synthesized_unaligned_image', util.tensor2im(generated[1].data[0])),
